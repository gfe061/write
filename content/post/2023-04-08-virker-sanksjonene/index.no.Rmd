...
```{r echo = F, fig.cap = "Norges handel med Russland", fig.align="center", out.width='100%'}
knitr::include_graphics("norge_handel.png")
# ![caption - this does not work here](url) -- normally works
```
